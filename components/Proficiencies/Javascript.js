...
import { svgVar, pathVar } from "@/components/variants";

import ProficiencySVGContainer from "./ProficiencySVGContainer";

const Javascript = () => {
  return (
    <ProficiencySVGContainer>
      <motion.svg
        variants={svgVar}
        initial="hidden"
        animate="visible"
